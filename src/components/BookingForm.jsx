...
const BookingForm = ({ setForeignApartments }) => {
  ...
  return (
    <div className='flex justify-center'>
        <div className="md:absolute md:top-[320px]  flex flex-col md:mx-auto mx-2 bg-white font-luxjost justify-center p-4 md:p-6 shadow-xl mt-10 rounded-3xl md:w-3/4 w-full ">
