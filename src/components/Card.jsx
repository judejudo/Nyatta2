...
const Card = () => {
  ...
  return (
    <div className="flex  px-8 sm:px-16 md:mt-32 font-luxjost ">
      <div className="grid  grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap- xl:grid-cols-3">
            ...
            return (
              <Link  to={`/Description`}>
                  ...
                  <div>
                    {imageUrl ? (
                      <img
                        src={imageUrl}
                        alt={name}
                        className="md:rounded-lg  rounded-sm h-[200px] w-[300px] md:h-[300px] md:w-[400px]"
                ...
                <div className="m-3 pr-3">
                  ...
                  <h2 className="font-semibold text-gray-700">Ksh{price} night</h2>
                  </div>
