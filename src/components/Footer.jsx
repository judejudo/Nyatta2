      ...
      <div className="flex w-full max-w-screen-xl flex-col items-center px-6">
        ...
        <div className="grid w-full grid-cols-1 gap-4 py-8 text-sm md:grid-cols-3">
          <div className="flex flex-col gap-1">
            ...
            <p>
              <Link to="/contactUs" className="cursor-pointer font-normal text-gray-700 decoration-1 underline-offset-1 hover:underline">
                Help Center
              </Link>
            </p>
            <p>
          ...
          <div className="flex flex-col gap-1">
            <strong className="font-medium">Nyatta Homes</strong>
            <p>
          ...
          <div className="flex flex-col gap-1">
            ...
            <ul className="flex flex-col gap-1">
              ...
              <li className="cursor-pointer text-gray-700 decoration-1 underline-offset-1 hover:underline">
              <Link to="/contactUs" >Terms & Conditions</Link>
              </li>
              <li className="cursor-pointer text-gray-700 decoration-1 underline-offset-1 hover:underline">
              <Link to="/contactUs" >Company Policy</Link>
              </li>
              <li className="cursor-pointer text-gray-700 decoration-1 underline-offset-1 hover:underline">
                <Link to="/contactUs" >Refund Claim Form</Link>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex w-full flex-col items-center justify-between gap-4 md:gap-0 lg:flex-row">
          ...
          <div className="flex w-full flex-col gap-2 px-1 font-normal text-gray-700 md:w-auto md:flex-row md:items-center md:gap-8">
            <p className="text-sm">&copy; {new Date().getFullYear()} Nyatta Homes</p>
